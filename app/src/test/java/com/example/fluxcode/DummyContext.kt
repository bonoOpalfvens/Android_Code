...
class DummyContext {
    ...
    val post = listOf(
        Post(1, "Retrofit with kotlin", "Retrofitting refers to the addition of new technology or features to older systems, for example: power plant retrofit, improving power plant efficiency", user, "15/12/2019", 1, 1, true),
